...
class AskParserFunction {
	...
	protected function disabled() {
		...
		$messageFormatter = $this->context->getDependencyBuilder()->newObject( 'MessageFormatter' );

		return $messageFormatter->addFromKey( 'smw_iq_disabled' )->getHtml();
	}
